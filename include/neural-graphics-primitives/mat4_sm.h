...
struct mat4_sm {
	...
	__host__ __device__ __forceinline__ mat4_sm() {
	...
	__host__ __device__ __forceinline__ mat4_sm operator*(const float f) const {
		mat4_sm ret;
	...
	__host__ __device__ __forceinline__ mat4_sm operator+(const mat4_sm& other) const {
		mat4_sm ret;
	...
	__host__ __device__ __forceinline__ mat4_sm transpose() const {
		mat4_sm ret;
	...
	__host__ __device__ __forceinline__ double det() const {
	...
	__host__ __device__ __forceinline__ mat4_sm inverse3x3() const {
		...
		mat4_sm minv; // inverse of matrix m

		minv[0][0] = (n22 * n33 - n32 * n23) * invdet;
		minv[1][0] = (n13 * n32 - n12 * n33) * invdet;
		minv[2][0] = (n12 * n23 - n13 * n22) * invdet;
		minv[0][1] = (n23 * n31 - n21 * n33) * invdet;
		minv[1][1] = (n11 * n33 - n13 * n31) * invdet;
		minv[2][1] = (n21 * n13 - n11 * n23) * invdet;
		minv[0][2] = (n21 * n32 - n31 * n22) * invdet;
		minv[1][2] = (n31 * n12 - n11 * n32) * invdet;
		minv[2][2] = (n11 * n22 - n21 * n12) * invdet;

		return minv;
	}
	__host__ __device__ __forceinline__ mat4_sm inverse() const {
		auto n11 = m[0][0], n12 = m[1][0], n13 = m[2][0], n14 = m[3][0];
		auto n21 = m[0][1], n22 = m[1][1], n23 = m[2][1], n24 = m[3][1];
		auto n31 = m[0][2], n32 = m[1][2], n33 = m[2][2], n34 = m[3][2];
		auto n41 = m[0][3], n42 = m[1][3], n43 = m[2][3], n44 = m[3][3];
	...
	__host__ __device__ __forceinline__ mat4_sm& operator*=(const float f) { return *this = *this * f; }
	__host__ __device__ __forceinline__ mat4_sm& operator/=(const float f) { return *this = *this / f; }
	__host__ __device__ __forceinline__ mat4_sm& operator+=(const mat4_sm& m) { return *this = *this + m; }
	__host__ __device__ __forceinline__ mat4_sm& operator-=(const mat4_sm& m) { return *this = *this - m; }
	__host__ __device__ __forceinline__ mat4_sm& operator*=(const mat4_sm& m) { return *this = *this * m; }
